...
AGsys("SENSOR URL API endpint " + SENSOR_URL)
...
while(True):
   ...
   flow_count = 0 # Reset flow count after logging start cycle to look for leads during sleep
   log_relay_status()
   engage_relays()
   for a in range (1,NUM_WATER_VALVES+1):
   ...
   CSVlog(["End_Water_Cycle",flow_count],CSV_PUMP)
   flow_count = 0
